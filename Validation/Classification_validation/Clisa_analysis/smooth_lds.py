...
if n_vids == 24:
    ...
    save_dir = os.path.join('runs_srt',
                            'raw_28video_batch28_dataset_both_timeLen5_tf16_sf16_multiFact2_lr0.000700_wd0.015000_epochs80_randSeed7_fold10_accSel_newPre_cls9')
...
for fold in range(n_folds):
    ...
    # lds each video from each subject
    for sub in range(n_subs):
        for i, step in enumerate(range(0, feature_de_norm.shape[1], 30)):
            subs_feature_lds[sub, step:step+30 ,:] = LDS(feature_de_norm[sub,step:step+30,:])
